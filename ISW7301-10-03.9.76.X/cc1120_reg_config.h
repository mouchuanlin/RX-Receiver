...
/*const registerSetting_t preferredSettings[]= 
{
  ...
  {CC1120_IOCFG2,            0x38},//06},         //40},     // pkt CRC OK
  {CC1120_IOCFG1,            0xB0},
  ...
  {CC1120_MODCFG_DEV_E,      0x04},         // FSK, 20kHz dev. (exponent)
  ...
  {CC1120_CHAN_BW,           0x02},//2},         // lower-power: use 0x05 (40kHz BW)
  {CC1120_MDMCFG1,           0x46},//C6},//40},//46},
  {CC1120_MDMCFG0,           0x05},//62},//05},
  {CC1120_SYMBOL_RATE2,      0x53},         //4E},//53},
  {CC1120_SYMBOL_RATE1,      0xA9},
  {CC1120_SYMBOL_RATE0,      0x2A},
  {CC1120_AGC_REF,           0x20},//9},         //0},//36},
  {CC1120_AGC_CS_THR,        0x20},//EC},         //19},//00},
  ...
  {CC1120_AGC_CFG0,          0x1F},//4dB hysteresis CF},//93},
...
//  {CC1120_SYNC_CFG0,         0x0B},//0x17 for 32bit sync
//  {CC1120_DEVIATION_M,       0x48},     // 10kHz dev.
//  {CC1120_MODCFG_DEV_E,      0x04},//05},     // FSK, 10kHz dev. (exponent)
//  {CC1120_DCFILT_CFG,        0x1C},
//  {CC1120_PREAMBLE_CFG1,     0x00},//18},   // No automatic preamble because preamble is written manually for 6s
//  {CC1120_PREAMBLE_CFG0,     0x33},// Made pqt stricter. 43 preamble symbols must be detected//2A},     // Preamble detection & Preamble qualifier
//  {CC1120_FREQ_IF_CFG,       0x40},     // Added for better specification; 32MHz Xtal
//  {CC1120_IQIC,              0x00},     // Would Jay recommend using IQ comp? Default value is 0x46
...
//  {CC1120_SYMBOL_RATE1,      0xA9},
//  {CC1120_SYMBOL_RATE0,      0x2A},
//  {CC1120_AGC_REF,           0x2E},//*20//36},
//  {CC1120_AGC_CS_THR,        0xEC},//00},
//  {CC1120_AGC_GAIN_ADJUST,   0x9A},//00},
//  {CC1120_AGC_CFG3,          0x91},//D1}    1001 0001
//  {CC1120_AGC_CFG2,          0x31},//*20},
//  {CC1120_AGC_CFG1,          0x69},//*A9},//A0},//was 0x32, now AGC is doing 24 samples
//  {CC1120_AGC_CFG0,          0xCF},//93},
//  {CC1120_FIFO_CFG,          0x00},
//  {CC1120_DEV_ADDR,          0x00},
//  {CC1120_SETTLING_CFG,      0x13},//33},//03},
//  {CC1120_FS_CFG,            0x12},
//  {CC1120_WOR_CFG1,          0x48},
//  {CC1120_WOR_CFG0,          0x20},
//  {CC1120_WOR_EVENT0_MSB,    0x17},     // for now, WOR wakes up every ~4s
//  {CC1120_WOR_EVENT0_LSB,    0x72},
//  {CC1120_PKT_CFG2,          0x04},
//  {CC1120_PKT_CFG1,          0x00},
//  {CC1120_PKT_CFG0,          0x00},     // fixed length
//  {CC1120_RFEND_CFG1,        0x0F},
//  {CC1120_RFEND_CFG0,        0x01},
//  {CC1120_PA_CFG2,           0x7F},//7C},
//  {CC1120_PA_CFG1,           0x56},
//  {CC1120_PA_CFG0,           0x7C},//7E},     //***TX upsampler factor = 64 here, but = 16 for RX sniff mode example. Increases power
//                                                // but **CRITICAL** to packet reception.
//  {CC1120_PKT_LEN,           0x06},             // Currently, Pkt length is fixed @ 6 bytes (excluding sync, including CRC)
...
// triggers on 2nd but not first pulse:
const registerSetting_t preferredSettings[]= 
{
  {CC1120_IOCFG3,            0xB0},         //38},// WOR EVENT 1   B0},
  {CC1120_IOCFG2,            0x06},//B0 for RSSI; 06 for bitbang; 06},//38}, //40},     // pkt CRC OK
  {CC1120_IOCFG1,            0xB0},
  {CC1120_IOCFG0,            0xB0},//0B},11},         //B0},//06},     // High-Z
  {CC1120_SYNC3,             0xC1},
  {CC1120_SYNC2,             0xDE},
  ...
  {CC1120_DCFILT_CFG,        0x1C},
  {CC1120_PREAMBLE_CFG1,     0x10},//04},         //18},   // 4bit automatic preamble because we want ACK return transmission as short as possible
  {CC1120_PREAMBLE_CFG0,     0x2A},         // Preamble detection & Preamble qualifier
  {CC1120_FREQ_IF_CFG,       0x40},         // Added for better specification; 32MHz Xtal
  {CC1120_IQIC,              0x00},         //46     // Would Jay recommend using IQ comp? Default value is 0x46
  {CC1120_CHAN_BW,           0x02},//2},         // lower-power: use 0x05 (40kHz BW)
  ...
  {CC1120_SYMBOL_RATE1,      0xA9},
  {CC1120_SYMBOL_RATE0,      0x2A},
  {CC1120_AGC_REF,           0x2E},//20},//2E},//0},//9},         //0},//36},
  {CC1120_AGC_CS_THR,        0xC0},//EC},//20},//70},//20},//EC},         //19},//00},
  {CC1120_AGC_GAIN_ADJUST,   0x00},//9A},//00},
  {CC1120_AGC_CFG3,          0x91},         //D1}
  {CC1120_AGC_CFG2,          0x20},         //3F},
  {CC1120_AGC_CFG1,          0x8A},//89},//A9},         //A0},//was 0x32, now AGC is doing 24 samples
  {CC1120_AGC_CFG0,          0x0F},//1F},//4dB hysteresis CF},//93},
  {CC1120_FIFO_CFG,          0x00},
  {CC1120_DEV_ADDR,          0x00},
  {CC1120_SETTLING_CFG,      0x0B},         //13},//33},//03},
  {CC1120_FS_CFG,            0x12},
  {CC1120_WOR_CFG1,          0x88},//0x48},
  {CC1120_WOR_CFG0,          0x20},//21},//20},//26},//
  {CC1120_WOR_EVENT0_MSB,    0x00},//07},//17},         //0B},//3s WOR     17},     // for now, WOR wakes up every ~4s
  {CC1120_WOR_EVENT0_LSB,    0xFF},//D0},//72},         //B9},//72},
  {CC1120_PKT_CFG2,          0x04},
  {CC1120_PKT_CFG1,          0x00},
  {CC1120_PKT_CFG0,          0x00},         // fixed length
  {CC1120_RFEND_CFG1,        0x0F},
